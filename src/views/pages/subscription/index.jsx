...
import { SUPPORT_TABLE_HEAD } from "app/constants/tableHeadings";
...
import { SUPPORT_ENQUERIES } from "app/config/endpoints";
...
import SubscriptionListHead from "./sections/SubscriptionListHead";
import SubscriptionRow from "./sections/SubscriptionRow";
...
function Subscription() {
  ...
  async function getEnqueries() {
    ...
    try {
      const response = await getRequest(
        `${SUPPORT_ENQUERIES.LIST}?${COMMON_PAGINATION.PAGE_NO.KEY}=${_pageNo}&${COMMON_PAGINATION.ROWS_PER_PAGE.KEY}=${rowsPerPage}&${COMMON_PAGINATION.SEARCH_TEXT.KEY}=${searchText}`
      );
  ...
  return (
    <>
      <AppHelmet title={DEFAULT_APP_TITLE.SUBSCRIPTION} />
      <PageContainer
        className="page-container users-page"
        heading={DEFAULT_APP_TITLE.SUPPORT}
      >
        <PageBreadcrumbs
          breadcrumbs={[
            <Link
            ...
            >
              {DEFAULT_APP_TITLE.DASHBOARD}
            </Link>,

            DEFAULT_APP_TITLE.SUBSCRIPTION,
          ]}
        />
        <Card
          sx={{ mt: 4, boxShadow: 3 }}
            ...
            <Grid container spacing={2} sx={{ mb: 2 }}>
              <Grid item xs={12} sm={6}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Typography variant="body1">
                    <strong>Name:</strong> {hoveredContent.fullname}
                  </Typography>
                </Stack>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Typography variant="body1">
                    <strong>Subject:</strong> {hoveredContent.subject}
                  </Typography>
                </Stack>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Typography variant="body1">
                    <strong>Type:</strong> {hoveredContent.type}
                  </Typography>
                </Stack>
              </Grid>
