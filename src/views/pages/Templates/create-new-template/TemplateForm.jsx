...
const TemplateForm = () => {
  ...
  useEffect(() => {
    if (templateDetails?.project_structure?.pages?.length > 0) {
      ...
      setPageData(templateDetails.project_structure.pages[0]);
      ...
      >
        ...
        <Grid item md={12} className="ps-0">
          ...
          >
                          ...
                          >
                            <div className="page-block position-relative w-100">
                              ...
                              >
                                ...
                                <div
                                  className={`dropdown_menu custom_dropdown ${
                                    isOpenPageOptions === page?.id
                                      ? "active_dropdown"
                                      : ""
                                  }`}
                                >
            ...
            {showTemplatePreview === "integrations" && <Integrations />}
          </Card>
        </Grid>
        <ImageModal
