  ...
  return (
    <div className="panel-wrap">
      <div className="setting-block border-bottom">
        <h6 className="fw-semibold mb-4">Find One Pair settings</h6>
        <div>
          <label
          ...
          <div className="control-box mt-3">
            <div className="form-label font-sm fw-medium  cursor-pointer">
              <label
                ...
                role="button"
              >
                <p>Time to memorize (in seconds)</p>
                <input
                  className="colorInput form-control theme-control"
                  type="number"
                  defaultValue={blockValues?.struct?.showToMemorizeTime}
                  onChange={(e) =>
                    handleChangenoSecondsmemorize(e.target.value)
                  }
                  min="0"
                />
              </label>
      ...
      <div className="setting-block border-bottom">
        <div className="form-label font-sm fw-medium  cursor-pointer">
          <label
            ...
            role="button"
          >
            <p>Delay before flipping cards (in seconds)</p>
            <input
              className="colorInput form-control theme-control"
              type="number"
      ...
      <div className="setting-block border-bottom">
        ...
        {blockValues?.struct?.isEnableRating && (
          <div className="control-box">
            ...
            <div className="mb-3">
              <label
                className="form-label font-sm fw-medium  gap-2 cursor-pointer"
                role="button"
              >Number of attempts
              </label>
                <input
...
export default FindPairSettings;
