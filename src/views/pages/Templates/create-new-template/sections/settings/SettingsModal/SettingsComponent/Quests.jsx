...
function Quests({ formData, questions, handleChangeImage }) {
      ...
      <div class="d-flex w-100 gap-3 gap-md-0">
        <div class="border-end scrollable-div result-list">
          <div className="sidebarquestions">
            {formData?.struct?.tiles?.tileList?.length !== 0 &&
              formData?.struct?.tiles?.tileList?.map((question, index) => (
        ...
        <div className="w-100 p-4 scrollable-div">
          {formData?.struct?.tiles?.tileList &&
            formData?.struct?.tiles?.tileList?.map((question, index) => (
