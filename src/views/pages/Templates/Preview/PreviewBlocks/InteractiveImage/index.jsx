...
function PreviewInteractiveImage({
  ...
  console.log("totalPinstotalPinstotalPinstotalPinstotalPins", blocks);
  ...
  console.log("pinPointData?.blink", pinPointData?.blink);
  ...
  console.log("pinPointDatapinPointDatapinPointDatapinPointData", pinPointData);
  ...
  console.log("matchedPinsmatchedPinsmatchedPins", blocks?.struct?.sucImg);
  return (
                  ...
                  >
                    ...
                    {matchedPins.map((pin, index) =>
                      blocks?.struct?.sucImg ? (
                        <img
                          key={index}
                          src={pin?.i || blocks?.struct?.sucImg}
                          alt="matched"
                          style={{
                            position: "absolute",
                            left: `${pin.l}%`,
