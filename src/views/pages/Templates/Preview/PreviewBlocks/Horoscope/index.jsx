...
function HoroscopePreview({ data,handleLink }) {
  console.log(data?.struct, "chckdsdsdddddfdfddfrtyhjkgfdsd");
  ...
  const handleOpenDetails = (data) => {
    setDetails(data);
    console.log(data, "checkdatatatdfahjva");
    setShowDetails(true);
  };
  ...
  console.log(data?.struct, "showLeadFormshowLeadForm");
  return (
    <div>
                      ...
                      <div className="final-screen is-win">
                        <div className="final-screen__image-container">
                          <div
                            ...
                            style={{
                              backgroundImage: `url(${details?.coverImage || "https://res.cloudinary.com/dwl5gzbuz/image/upload/v1739271156/Group_3_jl6d69.png"})`,
                            }}
                          ></div>
                        </div>
                        ...
                        <div className="final-screen__content">
                            ...
                            <>
                              {data?.struct?.innerPageLink ? (
                                <div className="restart-button__wrapper">
                                  <button
                                    onClick={()=> handleLink(data?.struct?.callToActionLink)}
                                    style={{
                          ...
                          {data?.struct?.isHideRestartButton !== true && (
                            <div className="restart-button__wrapper">
                              <button
                                className="btn btn-outline-dark"
                                onClick={handleBack}
