...
import ProductTemplateCard from "./TemplateProductCard";
const ProductList = () => {
    ...
    console.log(name, "dwijdi")
    const productListCallBack = () => {
        const _pageNo = 1;
        // const _pageNo = pageNo + 1;
        const roleId = !userTypeSelection ? "" : userTypeSelection;
        getProducts(
            `${TEMPLATES.GET_PRODUCT}?${COMMON_PAGINATION.PAGE_NO.KEY}=${_pageNo}&${COMMON_PAGINATION.ROWS_PER_PAGE.KEY}=${rowsPerPage}&product_name=${name}`,
            pageNo,
            roleId
        );
    };
