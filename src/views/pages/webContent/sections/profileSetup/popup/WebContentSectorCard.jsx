...
WebContentSectorCard.propTypes = {
...
export default function WebContentSectorCard({
  isLoading,
  path,
  title,
  icon,
  ...
  const handleOpenEditModal = () => {
    ...
    getTemplateCategory(`${SECTOR.GET_SECTOR}/${hoveredUserId}`);
  };
      ...
      <Box className={"web-content-card"}>
        ...
        >
          ...
          <Link
            ...
            to={`${ROUTE_SLUGS.PROFILE_SETUP}/${title?.replace(/[\s/]+/g, "-").toLowerCase()}`}
            state={{ name: title, id: id }}
          >
            <StyledIcon
