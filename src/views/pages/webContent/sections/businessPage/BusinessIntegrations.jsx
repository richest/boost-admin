...
const BusinessIntergrations = () => {
  ...
  const getContent = () => {
    getWebContent(`${WEB_CONTENT.GET}?key=BUSINESS_PAGE&section=INTERFATIONS`);
  };
...
export default BusinessIntergrations;
