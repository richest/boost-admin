...
const EducationRemoteLearning = () => {
  ...
  async function getWebContent(url) {
    ...
    try {
      ...
      if (success && status === RESPONSE_CODE[200]) {
        ...
        const { title,introImage } = parseValue;
  ...
  const getContent = () => {
    getWebContent(`${WEB_CONTENT.GET}?key=EDUCATION_PAGE&section=REMOTE`);
  };
...
export default EducationRemoteLearning;
