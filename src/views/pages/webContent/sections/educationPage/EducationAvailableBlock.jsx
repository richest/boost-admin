...
const EducationAvailableBlock = () => {
  ...
  async function getWebContent(url) {
    ...
    try {
      ...
      if (success && status === RESPONSE_CODE[200]) {
        ...
        const { title, description } = parseValue;
  ...
  const getContent = () => {
    getWebContent(`${WEB_CONTENT.GET}?key=EDUCATION_PAGE&section=AVAILABLE`);
  };
...
export default EducationAvailableBlock;
