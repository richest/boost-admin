...
const CreateHelpCenterModal = ({
  ...
  const uploadImage = async (event) => {
    ...
    if (selectedImage?.uploaded_images?.upload_image_response_id) {
      await deleteImage(selectedImage?.uploaded_images?.upload_image_response_id);
    }
  ...
  const onSubmit = async (data) => {
    if (!selectedImage) {
      // If no icon is selected, trigger validation
      trigger("icon");
      return;
    }
              ...
              >
                ...
                >
                  <Avatar
                    ...
                    color="danger"
                    src={selectedImage?.uploaded_images?.upload_image_url}
                  />

                  {selectedImage?.uploaded_images?.upload_image_url !== null &&
                  selectedImage?.uploaded_images?.upload_image_url !==
                    undefined ? (
...
export default CreateHelpCenterModal;
