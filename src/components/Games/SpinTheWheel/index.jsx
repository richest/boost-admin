...
function SpintheWheel({
  ...
  const [screenWidth, setScreenWidth] = useState(
    spinDivEle?.current?.offsetWidth
  );
  ...
  return (
    ...
    >
      ...
      <div className="game_mainParent">
        ...
        <div className="disabled-panel" ref={spinDivEle}>
          <>
            {isWin !== true && (
              <div id="remix-app-root">
                <div id="pagination"></div>
                        ...
                        >
                          <div
                            ...
                            style={{
                              ...
                              left: `calc(50% - ${
                                ((screenWidth / 992) * 200) / 2
                              }px)`, // This ensures the button is centered
                              top: `calc(50% - ${
                                ((screenWidth / 992) * 200) / 2
                              }px)`,
                            }}
                          ...
                          >
                            <svg
                              ...
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              <g clip-path="url(#clip0_2061_2519)">
                              ...
                              <defs>
                                ...
                                >
                                  ...
                                  <feBlend
                                    ...
                                    result="effect1_dropShadow_2061_2519"
                                  ></feBlend>
                                  <feBlend
                                    mode="normal"
                                    in="SourceGraphic"
                                    in2="effect1_dropShadow_2061_2519"
                                    result="shape"
                                  ></feBlend>
                                </filter>
                          ...
                          >
                            {wheelBlock?.sections.map((section, index) => {
                              const totalSections = wheelBlock?.sections.length;
                              const anglePerSection = 360 / totalSections;
                              const wheelDiameter = screenWidth - 32;
                              // Math.min(
                              //   screenWidth * 0.9,
                              //   720
                              // ); // Max width 720px, but scales down
                                    ...
                                    {ShowCover?.sectionType === "TEXT" ? (
                                      <div
                                        ...
                                        style={{
                                          ...
                                          fontWeight: "700",
                                          fontSize:
                                            "clamp(0.875rem, -0.8486rem + 4.7962vw, 2.125rem)", // Dynamic font size
                                        }}
                                      >
                                        {section?.text}
                                      </div>
      ...
      <ul
        className={`${
          isSelected ? "inlineControls selected-controls" : "inlineControls"
        }  `}
      >
        {!isFirst && (
          <li
